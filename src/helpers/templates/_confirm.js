const confirmationTemplate = ( username ) => {
  return `
          ...
          <table class="pc-email-container" width="100%" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 0 auto; max-width: 620px;">
            ...
            <![endif]-->
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                      <tr>
                        <td class="pc-sm-p-30 pc-xs-p-25-20" style="padding: 40px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; line-height: 30px; letter-spacing: -0.2px; color: #9B9B9B;" valign="top">
                                  Craft beer selvage fanny pack, 8-bit post-ironic keffiyeh iPhone mlkshk pop-up.
                                </td>
                              </tr>
                            </tbody>
                          </table>
